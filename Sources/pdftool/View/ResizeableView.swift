...
struct CGPointResizableViewAnchorPointPair {
    var point: CGPoint
    var lAnchorPoint: ResizableViewAnchorPoint
}
...
open class ResizableView: UIView {
    ...
    var isResizing: Bool {
        get {
            guard let lAnchorPoint = self.lAnchorPoint else { return false }
            return lAnchorPoint.adjustsH != 0.0
                || lAnchorPoint.adjustsW != 0.0
                || lAnchorPoint.adjustsX != 0.0
                || lAnchorPoint.adjustsY != 0.0
        }
    }
    ...
    func lAnchorPoint(touch: CGPoint) -> ResizableViewAnchorPoint {
        ...
        return closestPoint.lAnchorPoint
    }
    ...
    override open func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        self.borderView.isHidden = false
        self.lAnchorPoint = self.lAnchorPoint(touch: touch.location(in: self))
    ...
    func resize(using touch: inout CGPoint) {
        ...
        guard let superview = self.superview,
            ...
            let lAnchorPoint = self.lAnchorPoint else { return }
        ...
        var deltaW = lAnchorPoint.adjustsW * (touchStart.x - touch.x)
        let deltaX = lAnchorPoint.adjustsX * (-1.0 * deltaW)
        var deltaH = lAnchorPoint.adjustsH * (touch.y - touchStart.y)
        let deltaY = lAnchorPoint.adjustsY * (-1.0 * deltaH)
